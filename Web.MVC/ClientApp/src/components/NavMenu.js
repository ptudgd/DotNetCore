                    ...
                    <ul className="topnav" id="myTopnav">
                        <li>
                            <a title="Trang chủ" href="/">
                                <svg fill="#fff" width={18} height={18} viewBox="0 0 24 24">
                                <path d="M18 10.688l-3.375-3.375v-5.063h-2.25v2.813l-3.375-3.375-9 9v0.563h2.25v5.625h5.625v-3.375h2.25v3.375h5.625v-5.625h2.25z" /></svg>
                            </a>
                        </li>
                        {
